            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    ...
                    <div className="modal-body" type="text">
                        <form>
                            <div>
                                <label id="signupEmailLabel" htmlFor="signup-username">Email</label>
                            ...
                            <div>
                                ...
                                <div><input id="signup-password-input" type="password" name="password" placeholder="Required" autoComplete="on" /></div>
                            </div>
                        </form>
                    </div>
                </Modal.Body>
